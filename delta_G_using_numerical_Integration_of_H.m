...
H_al_different_temperatures;
H_h2_different_temperatures;

%%
% H2O: 

G_h2 = zeros(length(H_h2o),2);
G_h2(1,1) = 300;
G_h2(1,2) = 0; %%STP value of G_h2o [kj/mol] 
...
G_al(1,1) = 300;
G_al(1,2) = 0; %%STP value of G_Al [kj/mol] 
...
hold on
plot(G_h2(:,1),G_h2(:,2))
legend('al2o3','alooh','aloh3','h2o','al','h2')